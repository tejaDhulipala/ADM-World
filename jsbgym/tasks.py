...
from jsbgym.aircraft import Aircraft, available_aircraft
...
class HeadingControlTask(FlightTask):
    ...
    def get_initial_conditions(self) -> Dict[Property, float]:
        ...
        return {**self.base_initial_conditions, **extra_conditions} # merges two dictionaries
...
class APStraightAndLevel(HeadingControlTask):
    pass    